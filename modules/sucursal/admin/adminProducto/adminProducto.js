...
fetch("adminProducto/adminProductoData.json")
        .then(response =>{
...
export function loadTabla(){
    ...
    console.log(cuerpo);
    document.getElementById("tblProductoSucursal").innerHTML = cuerpo;
...
function loadTablas(productosData) {
    ...
    document.getElementById("tblProductoCentral").innerHTML = cuerpo;
}
